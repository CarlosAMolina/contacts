-- analyze new query all data
-- Hash Right Join  (cost=262.95..280.99 rows=61 width=2227) (actual time=1.712..1.724 rows=15 loops=1)
explain analyze
select * from (
 SELECT users.id,
    users.name,
...
-- all data
-- Sort  (cost=485.74..485.87 rows=55 width=2259)
